<? include ("site-structure/header.php") ?>
 ...
 <h2> The Grundle Special</h2>
    <h3>Glazed Pollock Marinated in a Seafood BBQ Sauce</h3>
		<img class="pic" src="pics/chicken-rice.jpg" alt="" height="40" width="50">
	...
	<article class = review>
      ...
      <h2>The Grundle Pizza</h2>
		...
		<img class="pic"  src="pics/adrian-pizza.jpg" alt="" height="40" width="50">
...
<img class="pic"  src="pics/chocolate-cake.jpg" alt="" height="40" width="50">
